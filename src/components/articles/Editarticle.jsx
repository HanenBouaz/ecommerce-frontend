...
const Editarticle = () => {
  ...
  const loadarticle = async () => {
    const res = await axios.get(`https://e-commerce-tau-six-49.vercel.app/api/api/articles/${id}`)
  ...
  const handleSave = async (e) => {
    try {
      e.preventDefault()
      await axios.put(`https://e-commerce-tau-six-49.vercel.app/api/api/articles/${id}`, article)
        .then(res => {
          navigate("/articles")
        })
    } catch (error) {
